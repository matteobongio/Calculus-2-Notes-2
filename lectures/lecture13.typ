...
#Definitionbox("Curl", [
   ...
   $
      ...
      &= 
      (frac(partial P, partial y) - frac(partial P, partial z)) arrow(i) -
      (frac(partial P, partial x) - frac(partial P, partial z)) arrow(j) +
      (frac(partial P, partial x) - frac(partial P, partial y)) arrow(k)
   $
